...
const AdminDropdown = () => {
    ...
    const notifCount = data.filter(item => item.status === "Waiting Approve").length
        ...
        <ul className="navbar-nav">
            <li className="nav-item dropdown">
                ...
                <div class="relative">
                    ...
                    <div class={notifCount !== 0 ? "notifCounterProfile avenir" : 'filestyle'}>
                        <p>{notifCount}</p>
                    </div>
                </div>
                </a>
                ...
                <li onClick={() => dispatch({ type: "LOGOUT" })} className="logout pointer">
