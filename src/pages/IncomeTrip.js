        ...
        <>
           ...
           <div className="mt-5 income-trip-container">
               <div className="d-flex justify-content-between income-trip-header">
                   <h1>Income Trip</h1>
                   <div>
                        <button data-bs-toggle="modal" data-bs-target="#addCountry" className="add-trip-btn me-5">Add Country</button>
                        <button className="add-trip-btn" onClick={handleToAddTrip}>Add Trip</button>
                   </div>
               </div>
                ...
                <div className="modal-dialog modal-dialog-centered">
                    <div className="modal-content width150">
                        ...
                        <img src="/assets/palm1.png" alt="" className="palm"/>
                            <div class="modal-title">Add Country</div>
                        <img src="/assets/flower.png" alt="" className="flower"/>
                        </div>
                        <div className="add-country">
                            <input onChange={(e) => handleOnChange(e)} type="text" value={country.name} placeholder="Country name.." />
                            <button data-bs-dismiss="modal" onClick={handleAddCountry} className="add-trip-btn">Add</button>
                        </div>
                    </div>
                </div>
            </div>
