		...
		<>
			...
			<div className="profile-status-nav">
				<button
					...
					onClick={() => filterPayment('Waiting Payment')}
				>
					Waiting Payment
				</button>
				<button
					className="yellow-gradient"
					onClick={() => filterPayment('Waiting Approve')}
				>
					Waiting Approve
				</button>
				<button
					className="green-gradient"
					onClick={() => filterPayment('Approved')}
				>
					Approved
				</button>
				<button
					className="red-gradient"
					onClick={() => filterPayment('Cancelled')}
				>
					Cancelled
				</button>
			</div>
									...
									<div className="payment-body d-flex">
										...
										<div className="pbody-end">
											...
											<input
												...
												id="proof"
												name="attachment"
												className="filestyle pointer avenir-thin fs-6 pointer a"
											></input>
										</div>
									</div>
