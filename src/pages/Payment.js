...
const Payment = () => {
    ...
    const waitingPayment = data?.filter(item => item?.status === 'Waiting Payment')
                ...
                {lastData?.map((item, i) => (
                    <>
                            ...
                            <div className="payment-container">
                                ...
                                <div className="payment-body d-flex">
                                    ...
                                    <div className="pbody-end" id={i}>
                                            <img className="box" src={preview ? preview : "/assets/struk.png" } alt="" />
                                        <label for="image">
                                            <div>
                                                <input type="file" id="image" className='pointer avenir-thin fs-6 pointer a' name="image" onChange={handleOnChange}></input>
                        ...
                        <div className="d-block end">
                            {form ? (
                                <button onClick={(e) => {handlePayment(item?.id); hide(e);}} data-bs-toggle="modal" data-bs-target="#exampleModal" className="pay-btn fs-5">Pay</button>
                            ) : (
                                <button onClick={() => {handlePayment(item?.id);}} className="pay-btn fs-5">Pay</button>
                            )}
                        </div>
                    </>
                    ))}
                    ...
                    <div className="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div className="modal-dialog modal-dialog-centered">
                            ...
                            <div className="modal-body popup">
                                <p>Your payment will be confirmed within 1 x 24 hours To see orders click 
                                 <Link to='/profile'>
